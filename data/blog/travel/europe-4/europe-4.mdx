...
그 블로그를 보고 사진찍기에 너무 좋을 것 같아서 다녀와봤어요.
하지만 제가 갔을때는 건물 외벽 공사를 하고 있었고 제대로된 사진을 찍지 못했어요.
하지만 이 맥도날드는 부다페스트 서부 기차역인 뉴가티역 바로 옆에 위치해 있어서 뉴가티역을 찍어봤어요.
![뉴가티역](./new-gatry.jpg)

# 마치며

비엔나에서 부다페스트로 이동하는데 시간을 많이 썼던 것 같아요. 무사히 부다페스트에 도착해서 다행이였어요.

> 다음 포스트는 부다페스트 2일차를 업로드하도록 할게요!